...
public class Materials {
    ...
    public final static ModArmorMaterial sourceSteel = new ModArmorMaterial(ArsArsenal.MODID+":sourcesteel",25,new int[]{4, 7, 9, 4}
            , 40, SoundEvents.ARMOR_EQUIP_NETHERITE,3.0f, () -> Ingredient.of(Items.NETHERITE_SCRAP));
    public final static ModArmorMaterial fire = new ModArmorMaterial(ArsArsenal.MODID+":fire",33,new int[]{3, 6, 8, 3}
            , 30, SoundEvents.GENERIC_BURN,3.0f, () -> Ingredient.of(Items.GHAST_TEAR));
    public final static ModArmorMaterial water = new ModArmorMaterial(ArsArsenal.MODID+":water",33,new int[]{3, 6, 8, 3}
            , 30, SoundEvents.BREWING_STAND_BREW,3.0f, () -> Ingredient.of(Items.ICE));
    public final static ModArmorMaterial earth = new ModArmorMaterial(ArsArsenal.MODID+":earth",33,new int[]{3, 6, 8, 3}
            , 30, SoundEvents.ANVIL_PLACE,3.0f, () -> Ingredient.of(Items.IRON_BLOCK));
    public final static ModArmorMaterial air = new ModArmorMaterial(ArsArsenal.MODID+":air",33,new int[]{3, 6, 8, 3}
